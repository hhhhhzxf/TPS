-- Flyway baseline schema for TPS backend.
-- Existing local databases can be baselined and then patched by DataInitializer if needed.
...
CREATE TABLE IF NOT EXISTS reports (
  ...
  evidence_image_urls VARCHAR(1000) COMMENT '举报凭证图片URL，逗号分隔',
